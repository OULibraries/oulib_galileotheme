...
<div class="location_index"> 
	<div class="row">
		...
		<div class="col-md-1 col-sm-1 hidden-xs">
			<div><a href="<?php print $node_url; ?>"><?php print render($content['field_icon']);?></a></div>
		</div>
		
		<div class="col-md-11 col-sm-11 col-xs-12"> 
			<div><?php print render($content['field_link']); ?></div>
			<div><?php print render($content['field_exhibit']); ?></div>
			<div class="exhibit-index-description"><?php print render($content['field_caption']); ?></div>
