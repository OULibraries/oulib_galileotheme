...
<div class="location_index"> 
	<div class="row">
		...
		<div class="col-md-10 col-sm-10 col-xs-12"> 
			...
			<div class="exhibit-index-location" style="float:left; padding:8px 8px 0px 0px;"><?php print render($content['field_location']); ?></div><div class="exhibit-index-location" style="float:left; padding:8px 0px 0px 0px;"><?php print render($content['field_room']); ?></div>
		</div>
